...
<template>
  <div class="bg-[#F7F5E0] pt-15 overflow-hidden">
    <img :src="props?.user?.foto_perfil?.url" alt="Foto do usuário"
      class="w-full h-[610px] object-cover md:w-[50%] md:ml-[25%] md:max-h-[500px] lg:max-h-[580px] md:rounded-[25%] md:h-[100%] md:border-15 md:border-[#40A9F4]" />
  </div>
  <section class="bg-[#F7F5E0]">
    ...
    <div
      class="text-center flex flex-wrap mb-10 gap-5 justify-center bg-[#F7F5E0] pt-10 lg:ml-27 sm:max-w-[1000px] md:gap-10">
      <button @click="$emit('logout')" class="bg-[#98CB2A] mt-10 w-[50%] text-lg pt-2 pb-2 rounded-2xl font-[Sen] cursor-pointer border-2 border-transparent transition-all duration-500 hover:bg-transparent hover:border-[#98CB2A] hover:text-[#98CB2A] sm:w-[20%]"><span class="mdi mdi-arrow-left-bold-outline"></span> Sair
      </button>
