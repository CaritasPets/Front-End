...
<template>
    <h2 class="text-center text-4xl text-[#4c260a] font-[Handlee] md:text-5xl lg:text-6xl">Nosso Objetivo</h2>
    <div class="block items-center lg:flex lg:justify-between">
        ...
        <p>
            <img class="w-800 mx-auto mt-15 lg:ml-15" src="/img_gatoDormindo.svg" alt="gato dormindo">
        </p>
    </div>
</template>