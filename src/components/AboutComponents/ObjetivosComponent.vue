...
<template>
    <h2 class="text-center text-4xl text-[#4c260a] font-[Handlee] md:text-6xl lg:text-7xl">Nosso Objetivo</h2>
    <div class="block items-center lg:flex lg:justify-between">
        ...
        <p>
            <img class="w-700 mx-auto mt-15 lg:ml-15" src="/img_gatoDormindo.svg" alt="gato dormindo">
        </p>
    </div>
</template>