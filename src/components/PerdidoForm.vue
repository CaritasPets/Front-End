        ...
        <ul>
          <li class="flex flex-col gap-y-2">
            ...
            <input class="text-2xl bg-[#FFF493] text-[#104C00] py-2 px-4 my-2 border-x-6 border-y-3 rounded-2xl w-150"
              placeholder="Nome do pet." v-model="nomePet" type="text" required />
          </li>
          <li class="flex flex-col gap-y-2">
          ...
          <li class="flex flex-col gap-y-2">
            <label class="text-3xl text-[#1E0B00]">Gênero do Pet:</label>
          ...
          <li class="flex flex-col gap-y-2">
            ...
            <input class="text-2xl bg-[#FFF493] text-[#587911] py-2 px-4 my-2 border-x-6 border-y-3 rounded-2xl w-150"
              placeholder="Endereço no qual seu pet foi visto por último." v-model="localidade" type="text" required />
          </li>
        </ul>
      </div>
      <div>
        <ul>
          <li class="flex flex-col gap-y-2">
            ...
            <label for="fileInput"
              class="text-2xl bg-[#FFF493] text-[#587911] py-2 px-4 my-2 border-x-6 border-y-3 rounded-2xl w-150 cursor-pointer">
              Adicione aqui fotos do seu pet perdido.
              <span class="m-25 mdi mdi-folder-plus-outline"></span>
            </label>
            <div v-if="foto" class="text-xl text-[#587911]">
          ...
          <li class="flex flex-col gap-y-2">
            ...
            <input class="text-2xl bg-[#FFF493] text-[#D26100] py-2 px-4 my-2 border-x-6 border-y-3 rounded-2xl w-150"
              placeholder="Descreva aqui as características do seu pet perdido." v-model="caracteristicas" type="text" />
          </li>
          <li class="flex flex-col gap-y-2">
            <label class="text-3xl text-[#1E0B00]">Nome do Dono:</label>
            <input class="text-2xl bg-[#FFF493] text-[#03497B] py-2 px-4 my-2 border-x-6 border-y-3 rounded-2xl w-150"
              placeholder="Nome do dono de pet." v-model="nomeDono" type="text" />
          </li>
          <li class="flex flex-col gap-y-2">
            <label class="text-3xl text-[#1E0B00]">*Telefone para Contato:</label>
            <input class="text-2xl bg-[#FFF493] text-[#104C00] py-2 px-4 my-2 border-x-6 border-y-3 rounded-2xl w-150"
              placeholder="*Telefone para contato." v-model="telefone" type="text" required />
          </li>
        </ul>
      </div>
    </div>
