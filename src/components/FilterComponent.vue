...
<template>
  <section class="flex flex-col items-center mx-20">
    <div class="flex flex-col items-center w-full">
      <button class="flex gap-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl rounded-4xl bg-[#fae8ad] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-13 py-2 cursor-pointer text-[#4C260A] transition duration-300" @click="open = !open">
      ...
      "
      v-if="open" class="w-[140%] h-[150%] sm:w-[120%] md:w-[100%] lg:w-[80%] rounded-4xl p-4 sm:p-6 bg-[#fae8ad] flex flex-col gap-6 items-center mt-4">
