...
<template>
    <div class="rounded-4xl self-start font-[Sen]" :style="`background: ${props.background}`">
        <div @click="open = !open" class="text-2xl font-[Sen] sm:text-3xl md:text-4xl text-white rounded-t-4xl py-3 px-4 sm:px-6 md:px-8 flex justify-between" >
            <h3 class=" font-[Sen]">{{ props.title }}</h3>
